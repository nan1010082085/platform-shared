...
export function createChatParityAssistantWorkflowGraph(): AgentWorkflowGraph {
  return layoutAgentWorkflowGraph({
    ...
    edges: [
      ...
      { id: 'e2', source: 'intent-router-1', target: 'req-analyzer-1', sourceHandle: 'needsAnalysis', data: { branch: 'needsAnalysis' } },
      ...
      { id: 'e7', source: 'intent-router-1', target: 'expert-1', sourceHandle: 'matched', data: { branch: 'matched' } },
      { id: 'e8', source: 'expert-1', target: 'collab-router-1' },
      { id: 'e9', source: 'collab-router-1', target: 'expert-1', sourceHandle: 'continue', data: { branch: 'continue', label: '继续协作' } },
      { id: 'e10', source: 'collab-router-1', target: 'task-chain-1', sourceHandle: 'nextStep', data: { branch: 'nextStep', label: '下一任务' } },
      { id: 'e11', source: 'collab-router-1', target: 'summarizer-1', sourceHandle: 'summarize', data: { branch: 'summarize', label: '生成摘要' } },
